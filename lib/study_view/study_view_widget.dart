...
export 'study_view_model.dart';

class StudyViewWidget extends StatefulWidget {
  const StudyViewWidget({
    super.key,
    this.contentType,
    this.filterType,
  });
  ...
  @override
  _StudyViewWidgetState createState() => _StudyViewWidgetState();
}

class _StudyViewWidgetState extends State<StudyViewWidget> {
  late StudyViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudyViewModel());
