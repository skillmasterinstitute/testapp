...
import 'create_slides_model.dart';
export 'create_slides_model.dart';

class CreateSlidesWidget extends StatefulWidget {
  const CreateSlidesWidget({super.key});

  @override
  _CreateSlidesWidgetState createState() => _CreateSlidesWidgetState();
}

class _CreateSlidesWidgetState extends State<CreateSlidesWidget> {
  late CreateSlidesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSlidesModel());
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '58trxowh' /* Recommended Image Size: 800px ... */,
                                ),
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<SliderRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<SliderRecord> columnSliderRecordList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final columnSliderRecord =
                            columnSliderRecordList.isNotEmpty
                                ? columnSliderRecordList.first
                                : null;
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        ...
                                                        await columnSliderRecord.reference
                                                            .update(
                                                                createSliderRecordData(
                                                          image1: _model
                                                              .uploadedFileUrl1,
                                                        ));
                                                      },
