...
class _StudentPageWidgetState extends State<StudentPageWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserRecord>(
      stream: UserRecord.getDocument(widget.refrence!),
      builder: (context, snapshot) {
        ...
        final studentPageUserRecord = snapshot.data!;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Hero(
                                            tag: studentPageUserRecord.photoUrl,
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      studentPageUserRecord.displayName,
